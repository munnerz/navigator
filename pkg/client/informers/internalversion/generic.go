...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case navigator.SchemeGroupVersion.WithResource("leaderlocks"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Navigator().InternalVersion().LeaderLocks().Informer()}, nil
