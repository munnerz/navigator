...
func RegisterConversions(scheme *runtime.Scheme) error {
	return scheme.AddGeneratedConversionFuncs(
		...
		Convert_v1alpha1_LeaderLock_To_navigator_LeaderLock,
		Convert_navigator_LeaderLock_To_v1alpha1_LeaderLock,
		Convert_v1alpha1_LeaderLockList_To_navigator_LeaderLockList,
		Convert_navigator_LeaderLockList_To_v1alpha1_LeaderLockList,
...
func autoConvert_v1alpha1_LeaderLock_To_navigator_LeaderLock(in *LeaderLock, out *navigator.LeaderLock, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	return nil
}

// Convert_v1alpha1_LeaderLock_To_navigator_LeaderLock is an autogenerated conversion function.
func Convert_v1alpha1_LeaderLock_To_navigator_LeaderLock(in *LeaderLock, out *navigator.LeaderLock, s conversion.Scope) error {
	return autoConvert_v1alpha1_LeaderLock_To_navigator_LeaderLock(in, out, s)
}

func autoConvert_navigator_LeaderLock_To_v1alpha1_LeaderLock(in *navigator.LeaderLock, out *LeaderLock, s conversion.Scope) error {
	out.ObjectMeta = in.ObjectMeta
	return nil
}

// Convert_navigator_LeaderLock_To_v1alpha1_LeaderLock is an autogenerated conversion function.
func Convert_navigator_LeaderLock_To_v1alpha1_LeaderLock(in *navigator.LeaderLock, out *LeaderLock, s conversion.Scope) error {
	return autoConvert_navigator_LeaderLock_To_v1alpha1_LeaderLock(in, out, s)
}

func autoConvert_v1alpha1_LeaderLockList_To_navigator_LeaderLockList(in *LeaderLockList, out *navigator.LeaderLockList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]navigator.LeaderLock)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_v1alpha1_LeaderLockList_To_navigator_LeaderLockList is an autogenerated conversion function.
func Convert_v1alpha1_LeaderLockList_To_navigator_LeaderLockList(in *LeaderLockList, out *navigator.LeaderLockList, s conversion.Scope) error {
	return autoConvert_v1alpha1_LeaderLockList_To_navigator_LeaderLockList(in, out, s)
}

func autoConvert_navigator_LeaderLockList_To_v1alpha1_LeaderLockList(in *navigator.LeaderLockList, out *LeaderLockList, s conversion.Scope) error {
	out.ListMeta = in.ListMeta
	out.Items = *(*[]LeaderLock)(unsafe.Pointer(&in.Items))
	return nil
}

// Convert_navigator_LeaderLockList_To_v1alpha1_LeaderLockList is an autogenerated conversion function.
func Convert_navigator_LeaderLockList_To_v1alpha1_LeaderLockList(in *navigator.LeaderLockList, out *LeaderLockList, s conversion.Scope) error {
	return autoConvert_navigator_LeaderLockList_To_v1alpha1_LeaderLockList(in, out, s)
}
